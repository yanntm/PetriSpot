# History: session narratives, frozen at the time of writing

An append-only sink. Each block below is a former `HANDOFF.md`, or a session
note, copied here whole when the handoff was rewritten to its current state.
Everything in it was true at the time of writing and nothing has been updated
since: paths, numbers and next steps are historical. Do not read it unless
asked to; the living documents are the READMEs, the design files at the root
and `HANDOFF.md`.

---

## Handoff as of 2026-09-07, 20:30 (flushed 2026-09-07 evening)
...
# Handoff as of 2026-09-07, 21:30 (superseded)
...
# Handoff as of 2026-09-08 05:35 (flushed 2026-09-10)
